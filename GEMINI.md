...
Rapid Setup Steps
Fast environment check: npm install && npm run build && npm run test
Pattern recognition: Quickly scan existing wallet implementations
Identify optimization opportunities: Look for performance improvements
Prototype solutions: Start with minimal working examples
...
Analyze requirements: Understand the feature scope quickly
Identify patterns: Find similar implementations for reference
Prototype solution: Create working implementation rapidly
Iterate and refine: Improve based on testing and feedback
Document thoroughly: Provide clear usage examples
Debugging Workflow
Reproduce issue: Create minimal test case
Analyze symptoms: Quick diagnosis of root causes
Generate fixes: Implement solutions efficiently
Verify resolution: Comprehensive testing of fixes
...
Focus on delivering practical, high-quality solutions that make blockchain testing more accessible and efficient for developers.# Gemini AI Instructions for Onchain Test Kit
